...
\begin{itemize}
  \item \textbf{Forno pré-aquecedor} (2 termopares tipo~K): posicionados para
    ...
    axiais na etapa de condiciona-mento térmico do biogás antes de sua
...
%     * Malha primária: controle de temperatura do leito (TCs internos).
%     * Malha secundária/cascata: temperatura da camisa (TCs externos).
%     * Malha do pré-aquecedor: controle independente de temperatura.
%   - Conectar a estratégia com a formulação da Seção 2.
%   - Descrever a lógica de intertravamento entre malhas.
