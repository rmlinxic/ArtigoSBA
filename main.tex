...
\author[Fourth]{Dr. Jo\~ao Am\'erico Vilela Junior}

\address[First]{Departamento de Engenharia Elétrica, Universidade
Federal do Paraná, Curitiba, Paraná, Brasil (e-mail: ricardo.israel@ufpr.br).}
\address[Second]{Departamento de Engenharia Elétrica, Universidade
Federal do Paraná, Curitiba, Paraná, Brasil (e-mail: gustavo.oliveira@ufpr.br).}
\address[Third]{Departamento de Engenharia Química, Universidade
Federal do Paraná, Curitiba, Paraná, Brasil (e-mail: helton.alves@ufpr.br).}
\address[Fourth]{Departamento de Engenharia Elétrica, Universidade
Federal do Paraná, Curitiba, Paraná, Brasil (e-mail: vilela@ufpr.br).}
