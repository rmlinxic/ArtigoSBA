...
correspondente (\(^\circ\)C). (\ref{eq:sp_dinamico}) pode ser reescrita de
...
da camisa utilizam $T_{\mathrm{alto}}$ como $T_{\mathrm{int}}$ em
(\ref{eq:sp_simplificada}), de modo que
